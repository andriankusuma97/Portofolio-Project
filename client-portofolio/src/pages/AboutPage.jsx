  ...
  return (
    <div className="wrapper print:text-xs mx-10 ">
      <div className="flex felx-row justify-between mb-10">
        ...
        <h1 className=" font-bold underline">Show Details</h1>
      </div>
      <div className="grid grid-cols-3 gap-4 text-slate-700">
        <div className="col-span-3 md:col-span-1 print:col-span-1">
        ...
        <div className="col-span-3 md:col-span-2 print:col-span-2">
